    ...
    <div>
      ...
      <div style={styles.page}>
        <div style={styles.imageStack}>
          ...
          >
            <img
              src="https://media.istockphoto.com/id/1324006497/photo/music-controller-dj-mixer-in-a-nightclub-at-a-party.jpg?s=612x612&w=0&k=20&c=AyXSZEWy3lHb7hKUfh9FXAsZGAO_p838uVaAlFbWa9k="
              alt="img3"
              style={{
                width: "100%",
                height: "100%",
